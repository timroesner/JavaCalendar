 ...
 * 2) problem with displaying events
 * 3) creating new events does not update the panel
 */
...
//			displayEvents(selectedDate);
	...
	public static void main(String[] args)
	{
		...
		LocalDate d1 = LocalDate.of(2017, 7, 26);
		LocalDate d2 = LocalDate.of(2017, 7, 29);
		LocalDate d3 = LocalDate.of(2017, 7, 30);
		LocalDate d4 = LocalDate.of(2017, 7, 2);
